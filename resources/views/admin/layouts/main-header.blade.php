    ...
    <div class="container-fluid">
        <div class="d-flex">
            <a class="header-brand d-md-none" href="#">
                <img src="{{ getFile(isset($setting) ? $setting->logo : null) }}" class="header-brand-img mobile-icon"
                    alt="logo">
            ...
            <div class="d-flex {{ lang() == 'en' ? 'ml-auto' : 'mr-auto' }} header-left-icons header-search-icon"
                ...
                <div class="dropdown profile-1">
                    @php
                        ...
                        $photo = 'https://ui-avatars.com/api/?background=009FE3&bold=true&color=ffff&name=' . $name;
                    @endphp
                    <a href="#" data-bs-toggle="dropdown" class="nav-link pl-2 pr-2 mt-2  leading-none d-flex">
                        ...
                        <div class="text-center mt-1 d-none d-xl-block">
                            <h6 class="text-dark mb-0 fs-13 font-weight-semibold text-capitalize">{{ $name }}
                            </h6>
                        </div>
                    </a>
                    <div
