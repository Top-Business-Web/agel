...
<!-- Start Switcher -->
{{--@include('vendor/layouts/switcher')--}}
<!-- End Switcher -->

<!-- GLOBAL-LOADER -->
@include('vendor/layouts/loader')
<!-- /GLOBAL-LOADER -->
        ...
        <div class="app-content">
            <div class="side-app">
                ...
                <div class="page-header">
                    <div>
                        <h1 class="page-title">{{trns('welcome_!')}} {{ auth()->user()->name }} <i class="fas fa-heart" style="color: #009FE3;"></i></h1>
                        <ol class="breadcrumb">
