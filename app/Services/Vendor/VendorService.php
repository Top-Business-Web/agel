...
class VendorService extends BaseService
{
    ...
    public function __construct(ObjModel $objModel, protected CityService $cityService, protected BranchService $branchService, protected VendorBranch $vendorBranch)
    {
